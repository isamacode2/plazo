  ...
  return (
    <div className="container-px max-w-2xl py-12">
      ...
      <div className="mt-6 flex flex-col gap-4 text-gray-700">
        <p>
          Plazo is a local classifieds marketplace built for communities in Accra, Ghana and
          across Croatia. It&apos;s a place to buy and sell items, find local services, discover
          housing and jobs, and connect with people organizing meetups and community events
          nearby.
        </p>
        <p>
